...
public class Constants
{
    ...
    public static final List<String> COMMAND_LIST = new ArrayList<>(
            Arrays.asList("move + north / east / west / south / up / down", "look + around / north / east / west / south / up / down", "quit or exit", "?", "help or info","map", "show inventory", "take + \"item\"", "drop + \"item\"")
    );
